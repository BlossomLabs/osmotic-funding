...
const main = async () => {
  ...
  const superConvictionVoting = await deploy("SuperConvictionVoting"); // <-- add in constructor args like line 19 vvvv
  ...
  */
  ...
  await tenderlyVerify(
    {contractName: "SuperConvictionVoting",
     contractAddress: superConvictionVoting.address
  })
  */
