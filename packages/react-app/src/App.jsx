...
function App(props) {
  ...
  const purpose = useContractReader(readContracts, "SuperConvictionVoting", "purpose");

  // 📟 Listen for broadcast events
  const setPurposeEvents = useEventListener(readContracts, "SuperConvictionVoting", "SetPurpose", localProvider, 1);
